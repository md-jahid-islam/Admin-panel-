...
import {
 ...
 const Sidebar = React.forwardRef<
  ...
  (
    ...
    return (
      <div ref={ref} className="group peer hidden md:block text-sidebar-foreground" data-state={state}
...
const SidebarMenuButton = React.forwardRef<
  ...
  (
    ...
    const button = (
      <Comp ref={ref} data-sidebar="menu-button"
        data-size={size}
    ...
    return (
      <Tooltip>
        ...
        <TooltipContent
        side="right" align="center" hidden={state !== "collapsed" || isMobile} {...tooltip}/>
      </Tooltip>
    )
  }
 )
 ...
 (({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    <div ref={ref} data-sidebar="menu-skeleton" className={cn("rounded-md h-8 flex gap-2 px-2 items-center", className)}
      {...props}>
      {showIcon && (
        <Skeleton

...
import { cn } from "@/lib/utils"
 ...
 (({ className, ...props }, ref) => (
  ...
  ref={ref} className={cn("fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]",className )} {...props}/>))
 ...
 (({ className, ...props }, ref) => (
  ...
  ref={ref} className={cn("text-sm font-semibold", className)} {...props}/>
 ))
